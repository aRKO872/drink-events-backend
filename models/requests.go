...
type SearchRadiusSetInput struct {
	SearchRadius  int `json:"search_radius" binding:"required,numeric"`
}

type DeletePairRequestInput struct {
	PairRequestId string `json:"pair_request_id" validate:"required"`
}

type AcceptPairRequestInput struct {
	PairRequestId string `json:"pair_request_id" validate:"required"`
